...
const content = {
  ...
  description:
    'Aviora prioritizes the security of your financial data. Our platform is built with robust security measures to ensure your information is always protected.',
  feature1: 'Enterprise-Grade Security',
  feature2: 'Data Encryption',
  feature3: 'Regular Security Audits',
  feature4: 'Compliance with Industry Standards',
};

export const Feature4 = () => {
  return (
    <Section id="feature-4" className="bg-[var(--background)] py-16 md:py-32">
