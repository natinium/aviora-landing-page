...
const content = {
  ...
  description: 'Aviora is a leading fintech analytics platform used by enterprises and developers.',
};
...
export const Navbar = () => {
  ...
  return (
    <nav data-state={menuState && 'active'} className="fixed z-20 w-full px-2">
      <div
        className={cn(
          'mx-auto mt-2 max-w-6xl px-6 transition-all duration-300 border-border rounded-2xl lg:px-12',
          isScrolled &&
